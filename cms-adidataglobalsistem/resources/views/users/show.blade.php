...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div>
            <a href="@signedUrl('users.index')" class="btn btn-gray-800 me-2">
                <span class="fas fa-arrow-left me-2"></span>Back
            </a>
        </div>
        <div>
            <a href="@signedUrl('users.edit', $viewUser->id)" class="btn btn-gray-800 d-inline-flex align-items-center me-2">
