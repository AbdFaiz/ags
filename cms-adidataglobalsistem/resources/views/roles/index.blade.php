...
<div>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <a href="@signedUrl('roles.create')" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                    ...
                    <td>
                        <div>
                            ...
                            <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                <a class="dropdown-item rounded-top" href=@signedUrl('roles.edit', $role->id)>
